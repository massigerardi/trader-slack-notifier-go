...
func main() {
    ...
    endpoints := services.Endpoints{
        ExecutionMessageEndpoint:   services.MakeExecutionMessageEndpoint(srv),
        TransactionMessageEndpoint: services.MakeTransactionMessageEndpoint(srv),
        TextMessageEndpoint:        services.MakeTextMessageEndpoint(srv),
    }
